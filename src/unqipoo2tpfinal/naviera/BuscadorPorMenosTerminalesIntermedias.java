...
public class BuscadorPorMenosTerminalesIntermedias implements BuscadorDeMejorCircuito {
	...
	public CircuitoMaritimo elegirMejorCircuito(List<CircuitoMaritimo> circuitos, TerminalPortuaria terminalDeLlegada) {
		CircuitoMaritimo mejorCircuito = circuitos.stream().
			min((CircuitoMaritimo c1, CircuitoMaritimo c2)
				->c1.cantidadDeTerminalesIntermedias(terminalDeLlegada).
				compareTo(c2.cantidadDeTerminalesIntermedias(terminalDeLlegada))).get();
